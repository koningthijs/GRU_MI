...
from model_functions import naive_previous_basket, naive_freq_basket, top_prod_acc, basket_GRU, basket_GRU_MI2, custom_BCE
#%%Load the data
...
f_name  = "MI2" + str(hidden_dim)+"_lr"+str(learning_rate)+"_sl"+str(schedual)+".pth"
...
#%% Initiate MI model 
network = basket_GRU_MI2(nprod,hidden_dim,discount_mask) 
