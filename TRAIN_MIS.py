...
import sys
import os
import hyperparameters_mis as hyperparameters
...
from model_functions import naive_previous_basket, naive_freq_basket, top_prod_acc, basket_GRU, basket_GRU_MIS, custom_BCE
#%%Load the data
...
f_name  = "MIS" + str(hidden_dim)+"_lr"+str(learning_rate)+"_sl"+str(schedual)+".pth"
...
#%% Initiate MI model 
network = basket_GRU_MIS(nprod,discount_mask) 
